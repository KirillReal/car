        ...
        <div class="row">
            <div class="col s12 card auto-form js-auto-info-container">
                <div class="auto-info-container">
                    <input type="hidden" value="" class="js-ads-type">
            ...
            <div class="col s6 offset-s3 card auto-form js-photo-container" style="display: none">
                <form class="col" action="<c:url value='/ads/photo'/>" method="post" enctype="multipart/form-data">
                    <div class="photo-container">
                        <input type="hidden" value="" class="js-ads-id" name="adsId">
